...
const DevisForm = () => {
  ...
  const [items, setItems] = useState([{ produit_id: "", qtte: 1, tax_rate: 0 }]);
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-600 mt-1">Créez un devis personnalisé pour vos clients</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Client Selection */}
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Sélection du Client</h2>
            <div>
