  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRole="admin" />}>
        <Route
          path="/admin"
          element={<AdminLayout isDark={isDark} setIsDark={setIsDark} />}
        >
          ...
          <Route
            ...
            element={<FormUsers isDark={isDark} />}
          />
          <Route
            path="update-user/:id"
            element={<UpdateUserForm isDark={isDark} />}
          />
          <Route path="clients" element={<Clients isDark={isDark} />} />
          <Route
            path="ajouter-client"
            element={<ClientForm isDark={isDark} />}
          />
          <Route
            path="modifier-client/:id"
            element={<UpdateClient isDark={isDark} />}
          />
          <Route path="produits" element={<Produits isDark={isDark} />} />
          <Route
            path="ajouter-produit"
            element={<ProduitForm isDark={isDark} />}
          />
          <Route
            path="modifier-produit/:id"
            element={<UpdateProduit isDark={isDark} />}
          />
          ...
          <Route
            ...
            element={<PageUpdateDevis isDark={isDark} />}
          />
          <Route
            path="documents/:id"
            element={<DocumentView isDark={isDark} />}
          />
          <Route path="picking-bl" element={<PagePicking isDark={isDark} />} />
          <Route
            path="picking-factures"
            element={<PagePickingInvoice isDark={isDark} />}
          />
        </Route>
      </Route>

      {/* 🔐 Commercial Routes */}
      <Route element={<ProtectedRoute allowedRole="commercial" />}>
        <Route
          path="/commercial"
          element={<CommercialLayout isDark={isDark} setIsDark={setIsDark} />}
        >
          <Route index element={<Navigate to="dashboard" />} />
          <Route path="dashboard" element={<Dashboard isDark={isDark} />} />
          <Route path="clients" element={<Clients isDark={isDark} />} />
      ...
      {/* 🔐 Atelier Routes */}
      <Route element={<ProtectedRoute allowedRole="atelier" />}>
        <Route
          path="/atelier"
          element={<AtelierLayout isDark={isDark} setIsDark={setIsDark} />}
        >
          <Route index element={<Navigate to="dashboard" />} />
          <Route path="dashboard" element={<Dashboard isDark={isDark} />} />
          <Route path="clients" element={<Clients isDark={isDark} />} />
      ...
      {/* 🔐 Comptable Routes */}
      <Route element={<ProtectedRoute allowedRole="comptable" />}>
        <Route
          path="/comptable"
          element={<COmptableLayout isDark={isDark} setIsDark={setIsDark} />}
        >
          <Route index element={<Navigate to="dashboard" />} />
          <Route path="dashboard" element={<Dashboard isDark={isDark} />} />
          <Route path="clients" element={<Clients isDark={isDark} />} />
      ...
      {/* 🔄 Root Redirect (Redirect based on role if logged in) */}
